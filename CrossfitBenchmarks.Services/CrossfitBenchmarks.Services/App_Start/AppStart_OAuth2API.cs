...
using CrossfitBenchmarks.Services.App_Start;
...
namespace CrossfitBenchmarks.Services.App_Start
{
    ...
    // ReSharper restore InconsistentNaming
    {
        ...
        {
            if (ConfigurationManager.AppSettings["WindowsAzure.OAuth.RelyingPartyRealm"] != null 
                && ConfigurationManager.AppSettings["WindowsAzure.OAuth.ServiceNamespace"] != null 
                && ConfigurationManager.AppSettings["WindowsAzure.OAuth.SwtSigningKey"] != null)
            {
